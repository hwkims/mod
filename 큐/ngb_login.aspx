...
var NgbSecurity = new function __NgbSecurity()
{
	...
	var _timeout;
	var _header;
	var _LP7LT6BR8CFLVQNH = new Array();
	...
	this.InitData = function()
	{
		...
		_LP7LT6BR8CFLVQNH.length = 0;
	}
	
	this.AddData = function( _W3BLIGFNDUIIGFFN )
	{
		if ( typeof( _url ) != 'undefined' && typeof( _timer ) != 'undefined' )
			return;
			
		_LP7LT6BR8CFLVQNH[ _LP7LT6BR8CFLVQNH.length ] = _W3BLIGFNDUIIGFFN;
	}
	...
	{
		if ( _LP7LT6BR8CFLVQNH.length == 0 || typeof( handler ) == 'undefined' )
			throw Exception;
	...
	this.HashString = function( _CYKQNJ7XPPHADPOW )
	{
		var hashString = NgbHash.HMAC_SHA256_MAC2( "4E65786F6E55736572", _CYKQNJ7XPPHADPOW );
		return hashString;
	}
	
	this.HashString2 = function( _61KFM1OJHP603OD5, _CYKQNJ7XPPHADPOW, _SF5DD92YWBOKW0VW )
	{
		var hashString = _61KFM1OJHP603OD5 + NgbHash.HMAC_SHA256_MAC( _SF5DD92YWBOKW0VW, NgbHash.HMAC_SHA256_MAC2( "4E65786F6E55736572", _CYKQNJ7XPPHADPOW ));
		return hashString;
	}
	...
	var ProcessEncrypt = function()
	{
		...
		var _W3BLIGFNDUIIGFFN = '';
		
		if ( typeof( _hash ) != 'undefined' )
			_W3BLIGFNDUIIGFFN = _hash + '\\';
			
		for ( var i = 0; i < _LP7LT6BR8CFLVQNH.length; i++ )
		{
			_W3BLIGFNDUIIGFFN += NgbRSA.utf8base64encode( _LP7LT6BR8CFLVQNH[ i ] );
			
			if ( i < _LP7LT6BR8CFLVQNH.length - 1 )
				_W3BLIGFNDUIIGFFN += '\\';
		}
		
		var val = EncryptString( key, _W3BLIGFNDUIIGFFN );
		_LP7LT6BR8CFLVQNH.length = 0;
	...
	var EncryptString = function( key, _LKC8U6J7F5802IFL )
	{
		...
		var a = new Array();
		var sl = _LKC8U6J7F5802IFL.length;
		
		var i = 0;
		while ( i < sl )
		{
			a[ i ] = _LKC8U6J7F5802IFL.charCodeAt( i );
			i++;
		}
...
var NgbLogin = new function __NgbLogin()
{
	...
	var _header;
	var _hashKey;
	var __8HUK38NFNBPMYR3A;
	var __8OJIU396MUQSJP7J;
	var _isLogin2;
	var _callBackMethod;
	var _isKeepLogin = '0';
	...
	var _ITASKLQ5GMOHNA2D;
	
	var _isInvalidPasswordHashKeyString = false;
    var _isFailover = false;
    var _isSLogin = '0';
	
	this.SetData = function( _8HUK38NFNBPMYR3A, _8OJIU396MUQSJP7J, accesscode, strRedirect, isSLogin )
	{
		__8HUK38NFNBPMYR3A = _8HUK38NFNBPMYR3A;
		__8OJIU396MUQSJP7J = _8OJIU396MUQSJP7J;
    ...
    this.SLogin = function (_8HUK38NFNBPMYR3A, _8OJIU396MUQSJP7J, accesscode, strRedirect) {
        NgbLogin.SetData(_8HUK38NFNBPMYR3A, _8OJIU396MUQSJP7J, accesscode, strRedirect, '1');
        _isLogin2 = false;

        if (_8HUK38NFNBPMYR3A.indexOf('@') != -1 )
        {
            var arrEmail = _8HUK38NFNBPMYR3A.split('@');

            if (arrEmail.length != 2 || arrEmail[0] == '' || arrEmail[1] == '' || _8HUK38NFNBPMYR3A.indexOf(' ') != -1 )
            {
                alert('아이디를 확인해 주세요.');
                return;
            }
            ...
            _isFailover = false;
            _ITASKLQ5GMOHNA2D = _8HUK38NFNBPMYR3A;
            AuthSystem.GetPasswordHashKey(_8HUK38NFNBPMYR3A, NgbLogin.HashHandler);
    ...
    this.Login = function (_8HUK38NFNBPMYR3A, _8OJIU396MUQSJP7J, accesscode, strRedirect)
	{
		NgbLogin.SetData( _8HUK38NFNBPMYR3A, _8OJIU396MUQSJP7J, accesscode, strRedirect);
		_isLogin2 = false;
	...
	this.Login2 = function( _8HUK38NFNBPMYR3A, _8OJIU396MUQSJP7J, callBackMethod, accesscode )
	{
        ...
        NgbLogin.SetData(_8HUK38NFNBPMYR3A, _8OJIU396MUQSJP7J, accesscode);
		_isLogin2 = true;
	...
	{
		_8HUK38NFNBPMYR3A = __8HUK38NFNBPMYR3A;
		_8OJIU396MUQSJP7J = __8OJIU396MUQSJP7J;
		accesscode = _accesscode;
		strRedirect = _strRedirect;
        isSLogin = _isSLogin;
		
		var strDomain = NgbLogin.GetLoginURL();
		_8HUK38NFNBPMYR3A = NgbString.Trim( _8HUK38NFNBPMYR3A );
		_8OJIU396MUQSJP7J = NgbString.Trim( _8OJIU396MUQSJP7J );
		...
		if ( _8HUK38NFNBPMYR3A == '' || _8HUK38NFNBPMYR3A.indexOf( ' ' ) != -1 )
		{
			alert( '아이디를 입력해 주세요.' );
			return;
		}
		else if ( _8OJIU396MUQSJP7J == '' )
		{
			alert( '비밀번호를 입력해 주세요.' );
			return;
		}
		...
		try
		{
			...
			NgbSecurity.AddData( _8HUK38NFNBPMYR3A );
			NgbSecurity.AddData( _8HUK38NFNBPMYR3A.indexOf( '@' ) != -1 ? NgbSecurity.HashString2( _header, _8OJIU396MUQSJP7J, _hashKey ) : _8OJIU396MUQSJP7J );
            NgbSecurity.AddData( NgbHash.SHA256_hash(_8OJIU396MUQSJP7J));
